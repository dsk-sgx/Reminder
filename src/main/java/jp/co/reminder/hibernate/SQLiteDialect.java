package jp.co.reminder.hibernate;
...
public class SQLiteDialect extends Dialect {
  ...
  // NOTE:Insert文のAutoIncrementがうまく動かなかったから足したけど、事象変わらず
  //  @Override
  ...
  //    return String.format("seq FROM sqlite_sequence WHERE name='%s'", sequenceName);
  //  }
